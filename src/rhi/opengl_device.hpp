...
inline OpenGLDevice::~OpenGLDevice() { Shutdown(); }
...
inline DeviceInfo OpenGLDevice::GetDeviceInfo() const {
  DeviceInfo info;
...
inline void
OpenGLDevice::ApplyDepthStencilState(const DepthStencilState &state) {
...
inline void OpenGLDevice::UpdateBuffer(BufferHandle buffer, const void *data,
...
OpenGLDevice::CreateTexture(const TextureDescriptor &desc) {
...
inline void OpenGLDevice::UpdateTexture(TextureHandle texture, const void *data,
                                        uint32_t mipLevel) {
...
inline SamplerHandle
OpenGLDevice::CreateSampler(const SamplerDescriptor &desc) {
...
inline GLuint OpenGLDevice::CompileShaderStage(const std::string &source,
                                               GLenum stage) {
...
inline PipelineHandle
OpenGLDevice::CreatePipeline(const PipelineDescriptor &desc,
                             ShaderHandle shader, const VertexLayout &layout) {
...
inline VertexArrayHandle
OpenGLDevice::CreateVertexArray(BufferHandle vertexBuffer,
                                BufferHandle indexBuffer,
...
inline void OpenGLDevice::DisableScissor() { glDisable(GL_SCISSOR_TEST); }
...
inline void OpenGLDevice::SetUniform(ShaderHandle shader,
...
inline void OpenGLDevice::SetUniformMatrix4(ShaderHandle shader,
                                            const std::string &name,
                                            const float *matrix) {
  auto it = shaders.find(shader.id);
  if (it == shaders.end())
...
inline void OpenGLDevice::WaitIdle() { glFinish(); }
